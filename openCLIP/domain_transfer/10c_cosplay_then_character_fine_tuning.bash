...
torchrun --nproc_per_node 2 -m open_clip_train.main -- \
  --name 10c_cosplay_then_character_train \
  --seed 42 \
  --dataset-type csv \
  ...
  --pretrained /home/ubuntu/open_clip/logs/10c_cosplay_finetuning/V1_10c_cosplay_train/checkpoints/epoch_5.pt \
  --batch-size 32 \
  --precision amp \
  --workers 4 \
  --warmup 50 \
  ...
  --save-frequency 1 \
  --report-to wandb \
  --logs /home/ubuntu/open_clip/logs/10c_cosplay_then_character_finetuning