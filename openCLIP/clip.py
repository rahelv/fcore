...
Usage:
  python clip_similarity.py                          # runs built-in demo
  python clip_similarity.py --images a.jpg b.png \
...
def run_demo(model, preprocess, tokenizer, device):
    """
    Demo with two synthetic solid-colour images and four text prompts.
    ...
    # create simple solid-colour test images in memory
    import tempfile, os
    ...
    texts = [
        ...
        "a blue square",
        "a green square",
        "a photo of a cat",   # deliberately off-topic
    ]

    img_embs  = embed_images(paths, model, preprocess, device)
    txt_[48;55;235;990;1880tembs  = embed_texts(texts, model, tokenizer, device)
