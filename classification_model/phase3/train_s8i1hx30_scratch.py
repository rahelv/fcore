"""
train_phase3_scratch.py — Re-run a sweep config from scratch for 200 epochs

Reads hyperparameters from an existing checkpoint (weights are NOT loaded),
then trains from scratch and logs to fcore_phase3_continued.

Usage
─────
  CUDA_VISIBLE_DEVICES=0 python3 train_s8i1hx30_scratch.py
"""
...
# FILL IN
# ─────────────────────────────────────────────
CHECKPOINT_PATH = "/home/ubuntu/data/models/fcore_hyperparam_sweep_3b_cutmix/fcore_hyperparam_sweep_3b_cutmix/s8i1hx30_best.pt"
...
PROJECT     = "fcore_phase3_continued"
...
if __name__ == "__main__":
    ...
    # Read config from checkpoint — weights are NOT loaded
    ...
    print(f"  lr={cfg.lr:.2e}  wd={cfg.weight_decay}  dropout={cfg.dropout_p}  ls={cfg.label_smoothing}")
    ...
    save_path = project_dir / f"{original_run_id}_scratch200_best.pt"

    with wandb.init(
        project=PROJECT,
        entity=ENTITY,
        name=f"{original_run_id}_scratch200",
        config={
